...
MTK_BUILD_VERNO=AllCall.S1.X.V1.8
BUILD_GMS=yes
XUNHU_QTY_SMART_WAKE_UP=yes
XUNHU_FLIP_MUTE=no
XUNHU_AUTO_CLEAN_BACKGROUND_MEMORY=yes
XUNHU_QTY_GESTURE_SOMATOSENSORY=yes
#功能:俄罗期项目拔号盘添加俄文字符
#使用方法:yes/no,默认no
...
#功能:设置默认时区 #GMT+2
XUNHU_DEFAULT_TIMEZONE=Europe/Madrid
#功能:设置默认语言
XUNHU_DEFAULT_LOCALE=en-US
# 功能：智能体感（原先的隔空手势)
# 使用方法：yes打开，no关闭
XUNHU_INTELLIGENT_SENSE=yes
...
#作者:trf1201
#功能:平台APP是否odex化，空间换时间，优化首次开机速度（39o版本一般会多出300Ｍ)
#使用方法:yes/no,默认no
XUNHU_DEXPREOPT_PREBUILTS=yes
...
#作者:TRF1205
#功能:去掉USB使用方式中的midi模式
#使用方法:yes/no,默认no
XUNHU_SUPPORT_USB_MIDI_MODE=yes
#作者:TRF1222
#功能:添加查询RF频段暗码*#2369#
#使用方法:yes/no,默认no
